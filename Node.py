...
class Node:
    def __init__(self, p, v, mass, transform = None):
        self.p = p
        self.v = v
        self.mass = mass
        self.f = Vector(0, 0)
    ...
    def draw(self, screen):
        pygame.draw.circle(screen, (10,10, 10), self.transform(self.p), 5)

class FixedNode(Node):
    def __init__(self, p, m, transform):
        super().__init__(p, Vector(0, 0), m, transform)
    def reset(self):
        pass
    def apply_force(self, f):
        pass
